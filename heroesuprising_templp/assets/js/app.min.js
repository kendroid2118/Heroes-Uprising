...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = e() }(this, (function() {
    ...
    function A(t, e) { return e && e + "::" + I++ || t.uidEvent || I++ }

    function z(t) { var e = A(t); return t.uidEvent = e, x[e] = x[e] || {}, x[e] }

    function D(t, e, i) { void 0 === i && (i = null); for (var n = Object.keys(t), o = 0, s = n.length; o < s; o++) { var r = t[n[o]]; if (r.originalHandler === e && r.delegationSelector === i) return r } return null }
    ...
    M.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', W.handleDismiss(new W)), b((function() {
        ...
        if (t) {
            var e = t.fn[N];
            t.fn[N] = W.jQueryInterface, t.fn[N].Constructor = W, t.fn[N].noConflict = function() { return t.fn[N] = e, W.jQueryInterface }
        }
    }));
    var B = function(t) {
        function i() { return t.apply(this, arguments) || this }
    ...
    var F = {
        ...
        V = function(t) {
            ...
            }, s.dispose = function() { t.prototype.dispose.call(this), M.off(this._element, ".bs.carousel"), this._items = null, this._config = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null }, s._getConfig = function(t) { return t = i({}, Q, t), h(U, t, K), t }, s._handleSwipe = function() {
            ...
            }, s._getItemIndex = function(t) { return this._items = t && t.parentNode ? Y.find(".carousel-item", t.parentNode) : [], this._items.indexOf(t) }, s._getItemByDirection = function(t, e) {
                var i = "next" === t,
                    n = "prev" === t,
            ...
            }, e(o, null, [{ key: "Default", get: function() { return Q } }, { key: "DATA_KEY", get: function() { return "bs.carousel" } }]), o
        }(H);
    M.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", V.dataApiClickHandler), M.on(window, "load.bs.carousel.data-api", (function() { for (var t = Y.find('[data-bs-ride="carousel"]'), e = 0, i = t.length; e < i; e++) V.carouselInterface(t[e], T(t[e], "bs.carousel")) })), b((function() {
        var t = y();
        if (t) {
            var e = t.fn[U];
            t.fn[U] = V.jQueryInterface, t.fn[U].Constructor = V, t.fn[U].noConflict = function() { return t.fn[U] = e, V.jQueryInterface }
        }
    }));
    var G = "collapse",
        Z = { toggle: !0, parent: "" },
        ...
        tt = function(t) {
            function o(e, i) {
                ...
                for (var o = Y.find('[data-bs-toggle="collapse"]'), s = 0, r = o.length; s < r; s++) {
                    var a = o[s],
                        c = l(a),
                        d = Y.find(c).filter((function(t) { return t === e }));
            ...
            return s.toggle = function() { this._element.classList.contains("show") ? this.hide() : this.show() }, s.show = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    var e, i;
                    this._parent && 0 === (e = Y.find(".show, .collapsing", this._parent).filter((function(e) { return "string" == typeof t._config.parent ? e.getAttribute("data-bs-parent") === t._config.parent : e.classList.contains("collapse") }))).length && (e = null);
                ...
                p(e) ? void 0 === e.jquery && void 0 === e[0] || (e = e[0]) : e = Y.findOne(e);
    ...
    function Et(t) { return Object.assign(Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 }), t) }

    function Ct(t, e) { return e.reduce((function(e, i) { return e[i] = t, e }), {}) }
    var xt = {
            name: "arrow",
            enabled: !0,
            phase: "main",
            ...
            effect: function(t) {
                var e = t.state,
                    ...
                    r = i.padding,
                    a = void 0 === r ? 0 : r;
                null != s && ("string" != typeof s || (s = e.elements.popper.querySelector(s))) && gt(e.elements.popper, s) && (e.elements.arrow = s, e.modifiersData[n + "#persistent"] = { padding: Et("number" != typeof a ? a : Ct(a, st)) })
            },
    ...
    var Lt = {
        ...
        zt = {
            ...
            effect: function(t) {
                ...
                return s && c.forEach((function(t) { t.addEventListener("scroll", i.update, At) })), a && l.addEventListener("resize", i.update, At),
                    function() { s && c.forEach((function(t) { t.removeEventListener("scroll", i.update, At) })), a && l.removeEventListener("resize", i.update, At) }
            },
            data: {}
        },
        Dt = { left: "right", right: "left", bottom: "top", top: "bottom" };

    function Pt(t) { return t.replace(/left|right|bottom|top/g, (function(t) { return Dt[t] })) }
    var $t = { start: "end", end: "start" };

    function jt(t) { return t.replace(/start|end/g, (function(t) { return $t[t] })) }
    ...
    function Nt(t) { return Mt(bt(t)).left + Ht(t).scrollLeft }
    ...
    function Bt(t, e) {
        void 0 === e && (e = []);
        var i = function t(e) { return ["html", "body", "#document"].indexOf(ct(e)) >= 0 ? e.ownerDocument.body : pt(e) && Wt(e) ? e : t(wt(e)) }(t),
            n = "body" === ct(i),
            o = dt(i),
    ...
    function qt(t, e) {
        return "viewport" === e ? Rt(function(t) {
            var e = dt(t),
                ...
                r = 0,
                a = 0;
            return n && (o = n.width, s = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (r = n.offsetLeft, a = n.offsetTop)), { width: o, height: s, x: r + Nt(t), y: a }
    ...
    function Ut(t, e) {
        ...
        var i = e,
            ...
            f = i.padding,
            h = void 0 === f ? 0 : f,
            m = Et("number" != typeof h ? h : Ct(h, st)),
            ...
            _ = Mt(v),
            k = Yt({ reference: _, element: y, strategy: "absolute", placement: o }),
            T = Rt(Object.assign(Object.assign({}, y), k)),
            S = "popper" === d ? T : _,
            E = { top: w.top - S.top + m.top, bottom: S.bottom - w.bottom + m.bottom, left: w.left - S.left + m.left, right: S.right - w.right + m.right },
    ...
    var Qt = {
        ...
        fn: function(t) {
            ...
            if (!e.modifiersData[n]._skip) {
                for (var o = i.mainAxis, s = void 0 === o || o, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, d = i.boundary, u = i.rootBoundary, p = i.altBoundary, f = i.flipVariations, h = void 0 === f || f, m = i.allowedAutoPlacements, g = e.options.placement, v = ht(g), y = l || (v !== g && h ? function(t) { if ("auto" === ht(t)) return []; var e = Pt(t); return [jt(t), e, jt(e)] }(g) : [Pt(g)]), b = [g].concat(y).reduce((function(t, i) {
                        return t.concat("auto" === ht(i) ? function(t, e) {
                            ...
                            0 === p.length && (p = u);
                            var f = p.reduce((function(e, i) { return e[i] = Ut(t, { placement: i, boundary: o, rootBoundary: s, padding: r })[ht(i)], e }), {});
                    ...
                    }), []), w = e.rects.reference, _ = e.rects.popper, k = new Map, T = !0, S = b[0], E = 0; E < b.length; E++) {
                    var C = b[E],
                        x = ht(C),
                        I = "start" === Ft(C),
                        O = [et, it].indexOf(x) >= 0,
                        L = O ? "width" : "height",
                        A = Ut(e, { placement: C, boundary: d, rootBoundary: u, altBoundary: p, padding: c }),
                        z = O ? I ? nt : ot : I ? it : et;
                    w[L] > _[L] && (z = Pt(z));
                    var D = Pt(z),
                        P = [];
                    if (s && P.push(A[x] <= 0), a && P.push(A[z] <= 0, A[D] <= 0), P.every((function(t) { return t }))) { S = C, T = !1; break }
                    k.set(C, P)
                }
                if (T)
                    for (var $ = function(t) { var e = b.find((function(e) { var i = k.get(e); if (i) return i.slice(0, t).every((function(t) { return t })) })); if (e) return S = e, "break" }, j = h ? 3 : 1; j > 0 && "break" !== $(j); j--);
        ...
        Jt = {
            ...
            fn: function(t) {
                var e = t.state,
                    ...
                    h = i.tetherOffset,
                    m = void 0 === h ? 0 : h,
                    g = Ut(e, { boundary: l, rootBoundary: c, padding: u, altBoundary: d }),
                    v = ht(e.placement),
                    y = Ft(e.placement),
                    b = !y,
                    w = Tt(v),
                    ...
                    T = e.rects.reference,
                    S = e.rects.popper,
                    E = "function" == typeof m ? m(Object.assign(Object.assign({}, e.rects), {}, { placement: e.placement })) : m,
                    C = { x: 0, y: 0 };
                if (k) {
                    if (s) {
                        var x = "y" === w ? et : ot,
                            ...
                            $ = "start" === y ? -S[O] : -T[O],
                            j = e.elements.arrow,
                            M = f && j ? mt(j) : { width: 0, height: 0 },
                            H = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 },
                            N = H[x],
                            W = H[I],
                            B = St(0, T[O], M[O]),
                            R = b ? T[O] / 2 - D - B - N - E : P - B - N - E,
                            q = b ? -T[O] / 2 + D + B + W + E : $ + B + W + E,
                            F = e.elements.arrow && kt(e.elements.arrow),
                            Y = F ? "y" === w ? F.clientTop || 0 : F.clientLeft || 0 : 0,
                            U = e.modifiersData.offset ? e.modifiersData.offset[e.placement][w] : 0,
                            Q = k[w] + R - U - Y,
                            K = k[w] + q - U,
    ...
    function te(t, e, i) {
        ...
        var n, o, s = bt(e),
            ...
            c = { x: 0, y: 0 };
        return (a || !a && !i) && (("body" !== ct(e) || Wt(s)) && (l = (n = e) !== dt(n) && pt(n) ? { scrollLeft: (o = n).scrollLeft, scrollTop: o.scrollTop } : Ht(n)), pt(e) ? ((c = Mt(e)).x += e.clientLeft, c.y += e.clientTop) : s && (c.x = Nt(s))), { x: r.left + l.scrollLeft - c.x, y: r.top + l.scrollTop - c.y, width: r.width, height: r.height }
    }
    ...
    var oe = ne(),
        ...
        ye = function(t) {
            ...
            return s.toggle = function() {
            ...
            }, s._getConfig = function(t) { return t = i({}, this.constructor.Default, F.getDataAttributes(this._element), t), h(le, t, this.constructor.DefaultType), t }, s._getMenuElement = function() { return Y.next(this._element, ".dropdown-menu")[0] }, s._getPlacement = function() { var t = this._element.parentNode; if (t.classList.contains("dropend")) return he; if (t.classList.contains("dropstart")) return me; var e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim(); return t.classList.contains("dropup") ? e ? ue : de : e ? fe : pe }, s._detectNavbar = function() { return null !== this._element.closest(".navbar") }, s._getPopperConfig = function() { var t = { placement: this._getPlacement(), modifiers: [{ name: "preventOverflow", options: { altBoundary: this._config.flip, rootBoundary: this._config.boundary } }] }; return "static" === this._config.display && (t.modifiers = [{ name: "applyStyles", enabled: !1 }]), i({}, t, this._config.popperConfig) }, o.dropdownInterface = function(t, e) {
                ...
                if (!(/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdown-menu")) : !ce.test(t.key)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))) {
                    ...
                    if (i && "Space" !== t.key) { var n = Y.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", e).filter(m); if (n.length) { var s = n.indexOf(t.target); "ArrowUp" === t.key && s > 0 && s--, "ArrowDown" === t.key && s < n.length - 1 && s++, n[s = -1 === s ? 0 : s].focus() } } else o.clearMenus()
                }
    ...
    var be = { backdrop: !0, keyboard: !0, focus: !0 },
        ...
        _e = function(t) {
            function o(e, i) { var n; return (n = t.call(this, e) || this)._config = n._getConfig(i), n._dialog = Y.findOne(".modal-dialog", e), n._backdrop = null, n._isShown = !1, n._isBodyOverflowing = !1, n._ignoreBackdropClick = !1, n._isTransitioning = !1, n._scrollbarWidth = 0, n }
            n(o, t);
            var s = o.prototype;
    ...
    var Ce = "tooltip",
        ...
        Oe = { animation: "boolean", template: "string", title: "(string|element|function)", trigger: "string", delay: "(number|object)", html: "boolean", selector: "(string|boolean)", placement: "(string|function)", container: "(string|element|boolean)", fallbackPlacements: "(null|array)", boundary: "(string|element)", customClass: "(string|function)", sanitize: "boolean", sanitizeFn: "(null|function)", allowList: "object", popperConfig: "(null|object)" },
        Le = { AUTO: "auto", TOP: "top", RIGHT: w ? "left" : "right", BOTTOM: "bottom", LEFT: w ? "right" : "left" },
        ...
        De = function(t) {
            ...
            }, e(o, null, [{ key: "Default", get: function() { return Ae } }, { key: "NAME", get: function() { return Ce } }, { key: "DATA_KEY", get: function() { return "bs.tooltip" } }, { key: "Event", get: function() { return ze } }, { key: "EVENT_KEY", get: function() { return ".bs.tooltip" } }, { key: "DefaultType", get: function() { return Oe } }]), o
        }(H);
    b((function() {
        var t = y();
        if (t) {
            var e = t.fn[Ce];
            t.fn[Ce] = De.jQueryInterface, t.fn[Ce].Constructor = De, t.fn[Ce].noConflict = function() { return t.fn[Ce] = e, De.jQueryInterface }
        }
    }));
    var Pe = "popover",
        $e = new RegExp("(^|\\s)bs-popover\\S+", "g"),
        je = i({}, De.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
        Me = i({}, De.DefaultType, { content: "(string|element|function)" }),
        ...
        Ne = function(t) {
            ...
            }, e(i, null, [{ key: "Default", get: function() { return je } }, { key: "NAME", get: function() { return Pe } }, { key: "DATA_KEY", get: function() { return "bs.popover" } }, { key: "Event", get: function() { return He } }, { key: "EVENT_KEY", get: function() { return ".bs.popover" } }, { key: "DefaultType", get: function() { return Me } }]), i
        }(De);
    b((function() {
        var t = y();
        if (t) {
            var e = t.fn[Pe];
            t.fn[Pe] = Ne.jQueryInterface, t.fn[Pe].Constructor = Ne, t.fn[Pe].noConflict = function() { return t.fn[Pe] = e, Ne.jQueryInterface }
        }
    }));
    var We = "scrollspy",
        ...
        qe = function(t) {
            ...
            return s.refresh = function() {
                ...
                var e = this._selector.split(",").map((function(e) { return e + '[data-bs-target="' + t + '"],' + e + '[href="' + t + '"]' })),
                    i = Y.findOne(e.join(","));
                i.classList.contains("dropdown-item") ? (Y.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add("active"), i.classList.add("active")) : (i.classList.add("active"), Y.parents(i, ".nav, .list-group").forEach((function(t) { Y.prev(t, ".nav-link, .list-group-item").forEach((function(t) { return t.classList.add("active") })), Y.prev(t, ".nav-item").forEach((function(t) { Y.children(t, ".nav-link").forEach((function(t) { return t.classList.add("active") })) })) }))), M.trigger(this._scrollElement, "activate.bs.scrollspy", { relatedTarget: t })
            }, s._clear = function() { Y.find(this._selector).filter((function(t) { return t.classList.contains("active") })).forEach((function(t) { return t.classList.remove("active") })) }, o.jQueryInterface = function(t) {
                return this.each((function() {
    ...
    M.on(window, "load.bs.scrollspy.data-api", (function() { Y.find('[data-bs-spy="scroll"]').forEach((function(t) { return new qe(t, F.getDataAttributes(t)) })) })), b((function() {
        var t = y();
        if (t) {
            var e = t.fn[We];
            t.fn[We] = qe.jQueryInterface, t.fn[We].Constructor = qe, t.fn[We].noConflict = function() { return t.fn[We] = e, qe.jQueryInterface }
        }
    }));
    var Fe = function(t) {
        function i() { return t.apply(this, arguments) || this }
        ...
        return o.show = function() {
            ...
            t.classList.add("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), v(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && t.parentNode.classList.contains("dropdown-menu") && (t.closest(".dropdown") && Y.find(".dropdown-toggle").forEach((function(t) { return t.classList.add("active") })), t.setAttribute("aria-expanded", !0)), i && i()
        }, i.jQueryInterface = function(t) {
            return this.each((function() {
    ...
    var Ye = { animation: "boolean", autohide: "boolean", delay: "number" },
        ...
        Qe = function(t) {
            ...
            }, e(o, null, [{ key: "DefaultType", get: function() { return Ye } }, { key: "Default", get: function() { return Ue } }, { key: "DATA_KEY", get: function() { return "bs.toast" } }]), o
        }(H);
    return b((function() {
        var t = y();
        if (t) {
            var e = t.fn.toast;
            t.fn.toast = Qe.jQueryInterface, t.fn.toast.Constructor = Qe, t.fn.toast.noConflict = function() { return t.fn.toast = e, Qe.jQueryInterface }
        }
    })), { Alert: W, Button: B, Carousel: V, Collapse: tt, Dropdown: ye, Modal: _e, Popover: Ne, ScrollSpy: qe, Tab: Fe, Toast: Qe, Tooltip: De }
})),
...
function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : t("object" == typeof exports ? require("jquery") : window.jQuery || window.Zepto) }((function(t) {
    ...
    var E, C, x, I = "inline",
        O = function() { x && (C.after(x.addClass(E)).detach(), x = null) };
    t.magnificPopup.registerModule(I, {
        options: { hiddenClass: "hide", markup: "", tNotFound: "Content not found" },
        proto: {
            initInline: function() { e.types.push(I), w(a + "." + I, (function() { O() })) },
            getInline: function(i, n) {
                if (O(), i.src) {
                    ...
                    if (s.length) {
                        ...
                        r && r.tagName && (C || (E = o.hiddenClass, C = _(E), E = "mfp-" + E), x = s.after(C).detach().removeClass(E)), e.updateStatus("ready")
    ...
    var L, A = "ajax",
        z = function() { L && t(document.body).removeClass(L) },
        D = function() { z(), e.req && e.req.abort() };
    t.magnificPopup.registerModule(A, {
        options: { settings: null, cursor: "mfp-ajax-cur", tError: '<a href="%url%">The content</a> could not be loaded.' },
        proto: {
            initAjax: function() { e.types.push(A), L = e.st.ajax.cursor, w(a + "." + A, D), w("BeforeChange." + A, D) },
            getAjax: function(i) {
                ...
                var n = t.extend({
                    ...
                    success: function(n, o, s) {
                        var r = { data: n, xhr: s };
                        k("ParseAjax", r), e.appendContent(t(r.data), A), i.finished = !0, z(), e._setFocus(), setTimeout((function() { e.wrap.addClass(h) }), 16), e.updateStatus("ready"), k("AjaxContentAdded")
                    },
    ...
    var P, $ = function(i) { if (i.data && void 0 !== i.data.title) return i.data.title; var n = e.st.image.titleSrc; if (n) { if (t.isFunction(n)) return n.call(e, i); if (i.el) return i.el.attr(n) || "" } return "" };
    t.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(t) { t.img && (t.hasSize = !0, P && clearInterval(P), t.isCheckingImgSize = !1, k("ImageHasSize", t), t.imgHidden && (e.content && e.content.removeClass("mfp-loading"), t.imgHidden = !1)) },
    ...
    var N = function(t) { var i = e.items.length; return t > i - 1 ? t - i : 0 > t ? i + t : t },
    ...
    t.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var i = e.st.gallery,
                    o = ".mfp-gallery";
                return e.direction = !0, !(!i || !i.enabled) && (s += " mfp-gallery", w(d + o, (function() { i.navigateByImgClick && e.wrap.on("click" + o, ".mfp-img", (function() { return e.items.length > 1 ? (e.next(), !1) : void 0 })), n.on("keydown" + o, (function(t) { 37 === t.keyCode ? e.prev() : 39 === t.keyCode && e.next() })) })), w("UpdateStatus" + o, (function(t, i) { i.text && (i.text = W(i.text, e.currItem.index, e.items.length)) })), w(c + o, (function(t, n, o, s) {
            ...
            next: function() { e.direction = !0, e.index = N(e.index + 1), e.updateItemHTML() },
            prev: function() { e.direction = !1, e.index = N(e.index - 1), e.updateItemHTML() },
...
function() {
    var t, e, i, n, o = { frameRate: 150, animationTime: 400, stepSize: 100, pulseAlgorithm: !0, pulseScale: 4, pulseNormalize: 1, accelerationDelta: 50, accelerationMax: 3, keyboardSupport: !0, arrowScroll: 50, fixedBackground: !0, excluded: "" },
        s = o,
        r = !1,
        a = { x: 0, y: 0 },
        l = !1,
    ...
    function k() {
        if (!l && document.body) {
            ...
            var n = document.body,
                ...
                d = n.scrollHeight;
            if (c = 0 <= document.compatMode.indexOf("CSS") ? o : n, t = n, s.keyboardSupport && R("keydown", I), top != self) r = !0;
            else if (st && a < d && (n.offsetHeight <= a || o.offsetHeight <= a)) {
                var u, p = document.createElement("div");
                if (p.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + c.scrollHeight + "px", document.body.appendChild(p), i = function() { u = u || setTimeout((function() { p.style.height = "0", p.style.height = c.scrollHeight + "px", u = null }), 500) }, setTimeout(i, 10), R("resize", i), (e = new X(i)).observe(n, { attributes: !0, childList: !0, characterData: !1 }), c.offsetHeight <= a) {
                    var f = document.createElement("div");
                    f.style.clear = "both", n.appendChild(f)
                }
            }
            s.fixedBackground || (n.style.backgroundAttachment = "scroll", o.style.backgroundAttachment = "scroll")
        }
    }
    var T = [],
        S = !1,
    ...
    function C(t, e, i) {
        if (function(t, e) { t = 0 < t ? 1 : -1, e = 0 < e ? 1 : -1, a.x === t && a.y === e || (a.x = t, a.y = e, T = [], E = 0) }(e, i), 1 != s.accelerationMax) {
            var n = Date.now() - E;
            if (n < s.accelerationDelta) {
                var o = (1 + 50 / n) / 2;
                1 < o && (o = Math.min(o, s.accelerationMax), e *= o, i *= o)
            }
            E = Date.now()
        }
        if (T.push({ x: e, y: i, lastX: e < 0 ? .99 : -.99, lastY: i < 0 ? .99 : -.99, start: Date.now() }), !S) {
            var r = V(),
                l = t === r || t === document.body;
            ...
            var c = function(n) {
                for (var o = Date.now(), r = 0, a = 0, d = 0; d < T.length; d++) {
                    var u = T[d],
                        p = o - u.start,
                        f = p >= s.animationTime,
                        h = f ? 1 : p / s.animationTime;
                    s.pulseAlgorithm && (h = Z(h));
                    var m = u.x * h - u.lastX >> 0,
                        g = u.y * h - u.lastY >> 0;
                    r += m, a += g, u.lastX += m, u.lastY += g, f && (T.splice(d, 1), d--)
                }
                l ? window.scrollBy(r, a) : (r && (t.scrollLeft += r), a && (t.scrollTop += a)), e || i || (T = []), T.length ? K(c, t, 1e3 / s.frameRate + 1) : (S = !1, null != t.$scrollBehavior && (t.style.scrollBehavior = t.$scrollBehavior, t.$scrollBehavior = null))
            };
            K(c, t, 0), S = !0
        }
    }
    ...
    function x(e) {
        ...
        u && (e.wheelDeltaX && Y(e.wheelDeltaX, 120) && (o = e.wheelDeltaX / Math.abs(e.wheelDeltaX) * -120), e.wheelDeltaY && Y(e.wheelDeltaY, 120) && (a = e.wheelDeltaY / Math.abs(e.wheelDeltaY) * -120)), o || a || (a = -e.wheelDelta || 0), 1 === e.deltaMode && (o *= 40, a *= 40);
        var c = H(i);
        return c ? !! function(t) {
            if (t) {
                d.length || (d = [t, t, t]), t = Math.abs(t), d.push(t), d.shift(), clearTimeout(n), n = setTimeout((function() { try { localStorage.SS_deltaBuffer = d.join(",") } catch (t) {} }), 1e3);
                var e = 120 < t && U(t),
                    i = !U(120) && !U(100) && !e;
                return t < 50 || i
            }
        }(a) || (1.2 < Math.abs(o) && (o *= s.stepSize / 120), 1.2 < Math.abs(a) && (a *= s.stepSize / 120), C(c, o, a), e.preventDefault(), void j()) : !r || !et || (Object.defineProperty(e, "target", { value: window.frameElement }), parent.wheel(e))
    }

    function I(e) {
        var i = e.target,
            n = e.ctrlKey || e.altKey || e.metaKey || e.shiftKey && e.keyCode !== g;
        document.body.contains(t) || (t = document.activeElement);
        var o = /^(button|submit|radio|checkbox|file|color|image)$/i;
        if (e.defaultPrevented || /^(textarea|select|embed|object)$/i.test(i.nodeName) || F(i, "input") && !o.test(i.type) || F(t, "video") || function(t) {
                var e = t.target,
                    i = !1;
                if (-1 != document.URL.indexOf("www.youtube.com/watch"))
                    do { if (i = e.classList && e.classList.contains("html5-video-controls")) break } while (e = e.parentNode);
                return i
        ...
        var a = 0,
            l = 0,
            c = H(t);
        if (!c) return !r || !et || parent.keydown(e);
        ...
        C(c, a, l), e.preventDefault(), j()
    }

    function O(e) { t = e.target }
    var L, A, z = (L = 0, function(t) { return t.uniqueID || (t.uniqueID = L++) }),
        D = {},
        P = {},
        $ = {};

    function j() { clearTimeout(A), A = setInterval((function() { D = P = $ = {} }), 1e3) }

    function M(t, e, i) { for (var n = i ? D : P, o = t.length; o--;) n[z(t[o])] = e; return e }

    function H(t) {
        var e = [],
            i = document.body,
            n = c.scrollHeight;
        do { var o = P[z(t)]; if (o) return M(e, o); if (e.push(t), n === t.scrollHeight) { var s = W(c) && W(i) || B(c); if (r && N(c) || !r && s) return M(e, V()) } else if (N(t) && B(t)) return M(e, t) } while (t = t.parentElement)
    }

    function N(t) { return t.clientHeight + 10 < t.scrollHeight }

    function W(t) { return "hidden" !== getComputedStyle(t, "").getPropertyValue("overflow-y") }

    function B(t) { var e = getComputedStyle(t, "").getPropertyValue("overflow-y"); return "scroll" === e || "auto" === e }

    function R(t, e, i) { window.addEventListener(t, e, i || !1) }

    function q(t, e, i) { window.removeEventListener(t, e, i || !1) }

    function F(t, e) { return t && (t.nodeName || "").toLowerCase() === e.toLowerCase() }
    if (window.localStorage && localStorage.SS_deltaBuffer) try { d = localStorage.SS_deltaBuffer.split(",") } catch (x) {}

    function Y(t, e) { return Math.floor(t / e) == t / e }

    function U(t) { return Y(d[0], t) && Y(d[1], t) && Y(d[2], t) }
    var Q, K = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(t, e, i) { window.setTimeout(t, i || 1e3 / 60) },
        X = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver,
        V = (Q = document.scrollingElement, function() {
            if (!Q) {
                var t = document.createElement("div");
                t.style.cssText = "height:10000px;width:1px;", document.body.appendChild(t);
                var e = document.body.scrollTop;
                document.documentElement.scrollTop, window.scrollBy(0, 3), Q = document.body.scrollTop != e ? document.body : document.documentElement, window.scrollBy(0, -3), document.body.removeChild(t)
            }
            return Q
        });

    function G(t) { var e; return ((t *= s.pulseScale) < 1 ? t - (1 - Math.exp(-t)) : (t -= 1, (e = Math.exp(-1)) + (1 - Math.exp(-t)) * (1 - e))) * s.pulseNormalize }

    function Z(t) { return 1 <= t ? 1 : t <= 0 ? 0 : (1 == s.pulseNormalize && (s.pulseNormalize /= G(1)), G(t)) }
    var J = window.navigator.userAgent,
        tt = /Edge/.test(J),
        et = /chrome/i.test(J) && !tt,
        it = /safari/i.test(J) && !tt,
        nt = /mobile/i.test(J),
        ot = /Windows NT 6.1/i.test(J) && /rv:11/i.test(J),
        st = it && (/Version\/8/i.test(J) || /Version\/9/i.test(J)),
        rt = (et || it || ot) && !nt,
        at = !1;
    try { window.addEventListener("test", null, Object.defineProperty({}, "passive", { get: function() { at = !0 } })) } catch (x) {}
    var lt = !!at && { passive: !1 },
        ct = "onwheel" in document.createElement("div") ? "wheel" : "mousewheel";

    function dt(t) { for (var e in t) o.hasOwnProperty(e) && (s[e] = t[e]) }
    ct && rt && (R(ct, x, lt), R("mousedown", O), R("load", k)), dt.destroy = function() { e && e.disconnect(), q(ct, x), q("mousedown", O), q("keydown", I), q("resize", i), q("load", k) }, window.SmoothScrollOptions && dt(window.SmoothScrollOptions), "function" == typeof define && define.amd ? define((function() { return dt })) : "object" == typeof exports ? module.exports = dt : window.SmoothScroll = dt
}();
...
var positionParallax = function(t, e, i, n) {
        var o = t.top / e - windowHeightExtra;
        i[n].style.top = o + "px"
    },
    animateParallax = function(t, e) {
        for (var i = 0; t.length > i; i++) {
            var n = t[i].parentElement.parentElement.getBoundingClientRect();
            0 <= n.top + n.height && n.top <= windowHeight && positionParallax(n, e, t, i)
        }
    },
    calculateHeight = function(t, e) {
        for (var i = 0; t.length > i; i++) {
            var n = t[i].parentElement.parentElement.getBoundingClientRect(),
                o = t[i].parentElement.parentElement.offsetTop,
                s = (windowHeight - n.height) / 2,
                r = windowHeight > n.height + o ? n.height + o - o / e : n.height + 2 * (s - s / e);
            t[i].style.height = r + 2 * windowHeightExtra + "px", positionParallax(n, e, t, i)
        }
    },
    universalParallax = function() {
        this.init = function(t) {
            void 0 === t && (t = {}), t = { speed: void 0 !== t.speed ? t.speed : 1.5, className: void 0 !== t.className ? t.className : "parallax" };
            for (var e = document.getElementsByClassName(t.className), i = 0; e.length > i; i++) {
                var n = document.createElement("div");
                e[i].parentNode.insertBefore(n, e[i]), n.appendChild(e[i]);
                var o = e[i].parentElement;
                ...
                var s = e[i].dataset.parallaxImage;
                void 0 !== s && (e[i].style.backgroundImage = "url(" + s + ")", 1 === e[i].classList.length && "parallax" === e[i].classList[0] && (e[i].style.backgroundRepeat = "no-repeat", e[i].style.backgroundPosition = "center", e[i].style.backgroundSize = "cover"))
            }
            document.addEventListener("readystatechange", (function(i) { var n, o; "complete" === i.target.readyState && (n = e, (o = t.speed) < 1 && (o = 1), calculateHeight(n, o), mobile || window.addEventListener("resize", (function() { windowHeight = window.innerHeight, calculateHeight(n, o) })), window.addEventListener("scroll", (function() { animateParallax(n, o) }))) }))
        }
    };